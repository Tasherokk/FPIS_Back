    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('curator', 'Curator'), ('student', 'Student')], max_length=20)),
                ('curator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='test',
            name='topic',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='test', to='courses.topic'),
        ),
        migrations.CreateModel(
            name='Enrollment',
            fields=[
